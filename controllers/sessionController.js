...
const bookSession = asyncHandler(async (req, res) => {
  ...
  // single atomic filter: not already booked AND capacity not exceeded
  ...
  if (updated.googleEventId) {
    try {
      ...
      // booking already saved above, not blocked by calendar failure
    }
  }
...
// GET /sessions/:id/roster — host only (FR1.6)
